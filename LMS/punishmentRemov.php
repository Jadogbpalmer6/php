    ...
    <div class="main-content">
        ...
        <div class="breadcrumb-container">
          ...
          <h5 class="text-success">
            you can simply click the id of the punishment to end the punishment
          </h5>
        
        <div class="myContainer">
            <h3 class="text-center">ALL punished users </h3>
             <table class="table">
                 <thead class="thead-dark">
                   <?php
                    ...
                    while ($dataAray=mysqli_fetch_assoc($querySql) ) { 
                        echo "<tbody>";
                        echo "<tr>";
                        echo " <td><a href='removP.php?id=$dataAray[punishmentId]'> $dataAray[punishmentId]"." </td>";
